...
func (s *rndSrc) Int63() int64 { _ = "STUB: not implemented"; return 0 }

func (s *rndSrc) Seed(n int64) { _ = "STUB: not implemented"; return }

// GetLangs returns a slice of available languages
func GetLangs() []string { _ = "STUB: not implemented"; return nil }

// SetLang sets the language in which the data should be generated
// returns error if passed language is not available
func SetLang(newLang string) error { _ = "STUB: not implemented"; return nil }

// UseExternalData sets the flag that allows using of external files as data providers (fake uses embedded ones by default)
func UseExternalData(flag bool) { _ = "STUB: not implemented"; return }
...
func EnFallback(flag bool) { _ = "STUB: not implemented"; return }

func (st samplesTree) hasKeyPath(lang, cat string) bool { _ = "STUB: not implemented"; return false }

func join(parts ...string) string { _ = "STUB: not implemented"; return "" }

func generate(lang, cat string, fallback bool) string { _ = "STUB: not implemented"; return "" }

func lookup(lang, cat string, fallback bool) string { _ = "STUB: not implemented"; return "" }

func _lookup(lang, cat string, fallback bool) string { _ = "STUB: not implemented"; return "" }
...
func readFile(lang, cat string) ([]byte, error) { _ = "STUB: not implemented"; return nil, nil }
