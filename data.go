...
func (f *_escFile) Close() error { _ = "STUB: not implemented"; return nil }
...
func (f *_escFile) Name() string { _ = "STUB: not implemented"; return "" }

func (f *_escFile) Size() int64 { _ = "STUB: not implemented"; return 0 }

func (f *_escFile) Mode() os.FileMode { _ = "STUB: not implemented"; return *new(os.FileMode) }

func (f *_escFile) ModTime() time.Time { _ = "STUB: not implemented"; return *new(time.Time) }

func (f *_escFile) IsDir() bool { _ = "STUB: not implemented"; return false }
...
func FS(useLocal bool) http.FileSystem { _ = "STUB: not implemented"; return *new(http.FileSystem) }
...
func FSByte(useLocal bool, name string) ([]byte, error) { _ = "STUB: not implemented"; return nil, nil }

// FSMustByte is the same as FSByte, but panics if name is not present.
func FSMustByte(useLocal bool, name string) []byte { _ = "STUB: not implemented"; return nil }
...
func FSMustString(useLocal bool, name string) string { _ = "STUB: not implemented"; return "" }
